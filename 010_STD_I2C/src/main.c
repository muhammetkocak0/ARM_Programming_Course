...
void i2c_cfg()
{
	...
	i2c_typedef.I2C_AcknowledgedAddress = I2C_AcknowledgedAddress_7bit;
	  ...
	  if(GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_0))
	  	  {
	  		  ...
	  		  i++;
	  		  for(int a = 0; a<1680000; a++);
	  	  }

	  	  switch(i)
	  	  {
	  	  case 0:
	  		  I2C_Write(S_address, 0x00);
	  		  break;
	  	  case 1:
	  		  I2C_Write(S_address, 0x01);
	  		  break;
	  	  case 2:
	  		  I2C_Write(S_address, 0x02);
	  		  break;
	  	  case 3:
	  		  I2C_Write(S_address, 0x04);
	  		  break;
	  	  case 4:
	  		  I2C_Write(S_address, 0x08);
	  		  break;
	  	  case 5:
	  		  I2C_Write(S_address, 0x10);
	  		  break;
	  	  case 6:
	  		  I2C_Write(S_address, 0x20);
	  		  break;
	  	  case 7:
	  		  I2C_Write(S_address, 0x40);
	  		  break;
	  	  case 8:
	  		  I2C_Write(S_address, 0x80);
	  		  break;
	  	  default:
	  		  i=0;
	  		  break;
